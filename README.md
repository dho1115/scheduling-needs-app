This is an app I am working on that allows managers (scheduling supervisors) to <strong style='color: red'>post scheduling needs and open shifts<> where employees can sign up for.
