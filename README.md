This is an app I am working on that allows managers (scheduling supervisors) to <h5>post scheduling needs</h5> and open shifts where employees can sign up for.
