This is an app I am working on that allows managers (scheduling supervisors) to <strong>post scheduling needs and open shifts</strong> where employees can sign up for.
